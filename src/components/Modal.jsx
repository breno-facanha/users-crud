              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <div className="mt-2 flex flex-col gap-4">
                    <Input name="Nome:" tipo="string" placeholder="Insira seu nome:" id="name"/>
                    <Input name="Email:" tipo="email" placeholder="Insira seu e-mail:" id="email"/>
                    <Input name="Telefone:" tipo="string"placeholder="Insira seu telefone:" id="fone"/>
                  </div>
                </div>
              </div>
            </div>
